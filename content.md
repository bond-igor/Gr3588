...
63. Задайте значение N. Напишите программу, которая выдает все натуральные числа в промежутке от 1 до N. 
...
67. примает на вход число и возвращает сумму цифр в числе
