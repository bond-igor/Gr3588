// Задайте двумерный массив из целыйх чисел. Напишите программу которая удалит строчку и столбец, на пересечении которых расположен наименьший элемент массива.
